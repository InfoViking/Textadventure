        ...
        internal void GoToDoctor()
        {
            ...
            else
            {
                Console.WriteLine("Diagnose: Der Arzt betet dir eine Liste an Verletzungen runter inklusive der Behandlungen die nötig sein werden,\n" +
                    ...
                    Console.ReadLine();
                    Console.WriteLine("Die Begrüßung zu Hause gestaltet sich herzlich aber als du deinen Eltern die Rechnung zeigst wird es schlagartig still. Glücklicherweise kann durch die hervorragenden\n" +
                    "Leistungen der MediServ eine angenehme und stämmbare Staffelung der Kosten erfolgen. Nichts desto trotz wirst du dazu verdonnert, für einen Teil der entstehenden Kosten\n" +
